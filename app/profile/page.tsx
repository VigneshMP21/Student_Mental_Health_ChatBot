        ...
        <div className="card">
          <div className="flex items-center gap-4 mb-6">
            <div className="relative">
              <div className="flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-primary-400 to-accent-400 text-2xl font-bold text-white">
                {avatarUrl ? (
              ...
              <Camera className="absolute -bottom-1 -right-1 h-6 w-6 rounded-full bg-white p-1 text-slate-400 shadow" aria-hidden="true" />
            </div>
            <div>
          ...
          <form onSubmit={handleProfileUpdate} className="space-y-4">
            ...
            <div>
              <label htmlFor="profile-avatar" className="block text-sm font-medium text-slate-700 mb-1.5">Profile Photo URL</label>
              <div className="relative">
                <Camera className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400" aria-hidden="true" />
                <input id="profile-avatar" type="url" value={avatarUrl} onChange={(e) => setAvatarUrl(e.target.value)} className="input-field pl-10" placeholder="https://..." />
              </div>
            </div>
