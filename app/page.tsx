      ...
      <main>
        ...
        <section className="relative overflow-hidden pt-32 pb-20 lg:pt-40 lg:pb-32" aria-labelledby="hero-heading">
          <div className="absolute inset-0 -z-10">
            ...
            <div className="absolute bottom-20 right-1/4 h-96 w-96 rounded-full bg-accent-400/20 blur-3xl" />
          </div>
              ...
              <div className="relative animate-fade-in">
                <div className="glass rounded-3xl p-8 shadow-2xl">
                  ...
                  <div className="space-y-4">
                    <div className="rounded-2xl bg-primary-50 p-4 text-sm text-slate-700">
                      I&apos;ve been feeling overwhelmed with finals coming up...
                    </div>
                    <div className="rounded-2xl bg-white border border-slate-100 p-4 text-sm text-slate-700 shadow-sm">
                      I hear you — finals can feel like a lot. Let&apos;s break this down together.
                      What&apos;s weighing on you most right now? 💙
                    </div>
                    <div className="flex gap-2">
                      <div className="h-2 w-2 rounded-full bg-primary-300 typing-dot" />
                      <div className="h-2 w-2 rounded-full bg-primary-300 typing-dot" />
                      <div className="h-2 w-2 rounded-full bg-primary-300 typing-dot" />
                    </div>
                  </div>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {features.map((feature) => (
                <div key={feature.title} className="card group hover:-translate-y-1">
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-primary-100 to-accent-100 text-primary-600 group-hover:from-primary-500 group-hover:to-accent-500 group-hover:text-white transition-all duration-300">
              ...
              {testimonials.map((t) => (
                <blockquote key={t.name} className="card">
                  ...
                  <footer className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-primary-400 to-accent-400 text-xs font-bold text-white">
                      {t.avatar}
                    </div>
                    <div>
              ...
              {faqs.map((faq) => (
                <details key={faq.q} className="card group">
                  <summary className="cursor-pointer text-sm font-semibold text-slate-900 list-none flex items-center justify-between">
                    {faq.q}
                    <span className="text-primary-500 group-open:rotate-45 transition-transform text-xl">+</span>
                  </summary>
        ...
        <section className="py-20 lg:py-28" aria-labelledby="cta-heading">
          <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
            <div className="glass rounded-3xl p-12 shadow-2xl">
              <h2 id="cta-heading" className="text-3xl font-bold text-slate-900 mb-4">
